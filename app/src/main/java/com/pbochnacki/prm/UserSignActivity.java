...
import com.pbochnacki.prm.databinding.ActivitySignInBinding;
...
public class UserSignActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.pbochnacki.prm.databinding.ActivitySignInBinding binding = ActivitySignInBinding.inflate(getLayoutInflater());
    ...
    private void firebaseAuthWithGoogle(GoogleSignInAccount acct) {
        ...
        firebaseAuth.signInWithCredential(credential)
                ...
                .addOnFailureListener(this, failure -> ToastMessageHandler.displayToastMessage(this, "Authentication failed!"));
    }
}